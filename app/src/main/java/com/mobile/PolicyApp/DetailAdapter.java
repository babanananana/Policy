...
public class DetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ArrayList<com.mobile.PolicyApp.DetailData> listData = new ArrayList<>();
    ...
    void addItem(com.mobile.PolicyApp.DetailData detailData) {
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(com.mobile.PolicyApp.DetailData detailData, int position) {
